...
import 'package:grocery_app/widgets/templates/create_page.dart';
...
// Bottom-left = top-left + height on Y axis
  ...
  Widget build(BuildContext context) {
    ...
    return CreatePage(
      ...
      topSectionBackgroundBuilder: BlocBuilder<DashboardBloc, DashboardState>(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: FileImage(File(bloc
                                .state.page.appBarImage!.path)), // local image
                  ...
                  return Positioned(
                    ...
                    child: Stack(
                      children: [
                        sectionBuilder(
                            section:
                                bloc.state.page.promoBanner.values.toList()[0]),
                        Positioned(
                          right: 0,
                          top: 0,
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  context
                                      .read<DashboardBloc>()
                                      .add(SetPromoSectionPosition(fromTop: 5));
                                },
      ...
      stickyTopSectionBuilder: StickyAppBar<DashboardState>(
      ...
      listSection: BlocBuilder<DashboardBloc, DashboardState>(
        builder: (context, state) {
